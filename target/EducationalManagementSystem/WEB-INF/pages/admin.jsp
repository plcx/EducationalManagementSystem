                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="${app}/user/list" target="mainF">用户列表</a></li>
                            <li><a href="${app}/user/addForm" target="mainF">添加用户</a></li>
                    ...
                    <li class="dropdown profile_details_drop">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <div class="profile_img">
                                <span class="prfil-img"><img src="${app}/userinfo/findPhoto?uid=${sessionScope.USER_SESSION.id}" alt=""> </span>
                                <div class="user-name">
                                    <p>${sessionScope.USER_SESSION.username}</p>
                        ...
                        <ul class="dropdown-menu drp-mnu">
                            <li> <a href="${app}/userinfo/findOne?id=${sessionScope.USER_SESSION.id}"><i class="fa fa-cog"></i> 用户设置</a> </li>
                            <li> <a href="#"><i class="fa fa-user"></i> Profile</a> </li>
                            <li> <a href="${app}/user/logout"><i class="fa fa-sign-out"></i> 退出登录</a> </li>
                        </ul>
                    </li>
                </ul>
            </div>
